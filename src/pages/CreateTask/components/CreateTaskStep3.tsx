  ...
  return (
    <div className="space-y-6">
      ...
      <div className=" rounded-xl py-4 mb-6">
        <div className="bg-[#1C1C1E] rounded-xl p-4 flex items-center justify-between mb-8">
        ...
        {/* Link */}
        <div className="border-t border-gray-800 p-5 rounded-lg bg-[#1C1C1E]">
          <h1 className="text-lg font-bold mb-4 border-b border-gray-600 pb-4">
            Details
          </h1>

          <div className="flex justify-between items-start mb-4">
            <span className="text-gray-400">Link</span>
            <div className="flex-1 max-w-[80%] ml-4 text-right">
