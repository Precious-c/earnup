    ...
    <div className="text-center mb-8 pt-4">
      ...
      <div className="grid grid-cols-3 gap-8 max-w-xs mx-auto">
        ...
        <button className="group flex flex-col items-center">
          <div onClick={() => navigate("/withdraw")} className="w-12 h-12 rounded-full bg-[#1C1C1E] flex items-center justify-center mb-2 group-hover:bg-[#2C2C2E] transition-colors">
