...
const Miner = () => {
  return (
    <div className="w-full rounded-2xl p-4 py-3 mb-4 relative overflow-hidden flex flex-col justify-center items-center">
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent animate-shine"></div>
      <div className="h-24 w-full flex text-left">
        <p>Mining game comming soon!</p>
      </div>
