...
export const BankForm = ({errors,formData,handleInputChange,handleSubmit,selectedOption}:Props) => (
    <div className="pt-4 pb-20">
      <div className="space-y-4 mb-6">
        ...
        <div>
          <label htmlFor="accountName" className="block text-sm text-gray-400 mb-1">
            Account Holder Name
          </label>
          <input
            type="text"
      ...
      <div className="flex items-start p-4 bg-[#1C1C1E] rounded-xl mb-6">
        ...
        <p className="text-sm text-gray-400">
          Make sure all bank details are correct. Additional fees may be charged by your bank.
        </p>
      </div>
