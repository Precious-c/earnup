...
export const tasksData: Task[] = [
  ...
  },
  {
    ...
    description:
      "Invite your friends to join Muna Wallet and earn rewards for each signup",
    icon: referIcon,
    totalPoints: 20000,
    type: "multi",
    status: "pending",
...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    id: 3,
    question:
      "Was Ethereum originally created to be a payment system like Bitcoin?",
    correctAnswer: "NO",
    explanation:
  ...
  },
  {
    id: 4,
    question:
      "Is 'HODL' a deliberate misspelling of 'hold' that became a popular term in crypto communities?",
    correctAnswer: "YES",
    explanation:
  ...
  },
  {
    id: 5,
    question:
      "Does a 'cold wallet' refer to a cryptocurrency wallet that's connected to the internet?",
    correctAnswer: "NO",
    explanation:
  ...
  },
  {
    id: 6,
    question:
      "Is 'gas' in Ethereum the fee paid to miners for processing transactions?",
    correctAnswer: "YES",
    explanation:
  ...
  },
  {
    id: 7,
    question:
      "Is a 'rug pull' a positive event where developers rapidly increase the value of their cryptocurrency?",
    correctAnswer: "NO",
    explanation:
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    href: "https://support.munawallet.com",
    external: true,
  },
];
